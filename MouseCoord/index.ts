...
export class MouseCoord implements ComponentFramework.StandardControl<IInputs, IOutputs> {
    ...
    private inputXValue : string;
    private inputYValue : string;
    ...
    public init(context: ComponentFramework.Context<IInputs>, notifyOutputChanged: () => void, state: ComponentFramework.Dictionary, container:HTMLDivElement): void
    {
        ...
        this.inputXValue = this._context.parameters.inputXValue.raw || "";
    ...
    public ValChange(event: MouseEvent):void {
        ...
        this.inputXValue = String(event.clientX - 21);
